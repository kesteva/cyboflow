...
const FROZEN_LINE_CAPS: Record<string, number> = {
  ...
  'orchestrator/verify/verificationScheduler.ts': 3401, // steps 5-7: preamble → four re-exported siblings; terminal write + delivery → TerminalDelivery; legacy capture engine → CapturePipeline
