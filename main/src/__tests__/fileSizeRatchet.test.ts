...
const FROZEN_LINE_CAPS: Record<string, number> = {
  ...
  'orchestrator/verify/verificationScheduler.ts': 4031, // step 5: contracts / leases / skip reasons / request rows → sibling modules (re-exported); step 6: terminal write + delivery → terminalDelivery.ts (TerminalDelivery collaborator)
