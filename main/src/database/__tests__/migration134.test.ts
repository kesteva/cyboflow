/**
 * Migration 134_project_solution_thoroughness.sql — projects.solution_thoroughness.
 *
...
const MIGRATION_134 = '134_project_solution_thoroughness.sql';
...
function migrationsDirWithout134(): string {
  ...
  for (const name of readdirSync(MIGRATIONS_DIR)) {
    if (name === MIGRATION_134) continue;
