...
import { setCyboflowDirectory, getCyboflowSubdirectory, getCyboflowDirectory, resolvePackagedVariant } from './utils/cyboflowDirectory';
 ...
 */
function appIconBasename(): string {
