...
- **doc** — a proposed CLAUDE.md / CODE-PATTERNS.md edit (you only propose it; the
  ...
  all applied changes are reviewed together at the terminal human-review merge gate —
  do not use the word "decision" as a tag, it is the review-item kind, not a bucket.
  Doc edits
