...
- captured screenshots from the **visual-verify** merge-gate are produced and
  surfaced **centrally** — the central verification agent builds the deliverable in a
  ...
  behavior report itself. You do NOT capture screenshots for the visual-verify step or
