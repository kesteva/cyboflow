 ...
 * drain-priority policy, the §5.2 seam-2 await primitives, the row/summary
 * shapes they read, the LEASE-NAME builders, and the abort-bounded await. Every
 * symbol here is a module-level constant, a plain type, or a pure free function;
 * nothing touches the scheduler instance or its private state, which is exactly
 * why it can live beside it.
 *
