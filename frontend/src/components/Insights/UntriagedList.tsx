 ...
 * cross-project view mixes findings from several projects). The UNTRIAGED list is
 * deliberately UNFILTERED — triage is cross-project; only the READY-to-compound
 * selection narrows to a single project (a compound run is single-project).
 */
