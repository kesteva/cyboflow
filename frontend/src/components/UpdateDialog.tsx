          ...
          <div className="space-y-4">
              ...
              <div className="bg-status-success/10 border border-status-success/30 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-text-secondary mb-4">
                      The update has been downloaded successfully. Cyboflow will restart to apply the update.
                    </p>
                    <Button
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-3">
                        ...
                        <ol className="text-sm text-text-secondary list-decimal list-inside ml-2 space-y-2">
                          ...
                          <li>Close Cyboflow</li>
                          <li>Open the downloaded .dmg file</li>
                          <li>Drag Cyboflow to your Applications folder</li>
                          <li>Launch the new version of Cyboflow</li>
                        </ol>
            ...
            {!versionInfo?.hasUpdate && updateState === 'idle' && (
              <div className="text-center py-8">
                ...
                <p className="text-text-secondary">You're running the latest version of Cyboflow!</p>
              </div>
            )}
          </div>
